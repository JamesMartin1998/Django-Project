...
urlpatterns = [
    ...
    path('movies/<slug:slug>/shows/<int:id>/', views.MakeOrder.as_view(),
         name='order'),
    path('edit-booking/<int:id>/', views.EditBooking.as_view(),
         name='edit-booking'),
    path('delete-booking/<int:id>/', views.delete_booking_page,
         name='delete-booking'),
